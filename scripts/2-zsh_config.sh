...
curl -L https://github.com/iWas-Coder/iQtile/raw/main/dotfiles/zsh_user.zip > zsh_user.zip
curl -L https://github.com/iWas-Coder/iQtile/raw/main/dotfiles/zsh_root.zip > zsh_root.zip
unzip zsh_user.zip
rm zsh_user.zip
...
echo "DONE! ZSH is now configured."
